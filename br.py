...
class BootRecord:
    def __init__(self, buffer):
        ...
        bb.offset = 0x0b # ByteBuffer2클래스에서 m_offset인데 왜..
        self.sector_size  = bb.get_uint2_le() # offset 2 증가
        self.sector_count = bb.get_uint1() # offset = 0x0d
        ...
        bb.offset = 0x0e
        self.fat_area_addr = bb.get_uint2_le() * self.sector_size # fat#1 주소
...
if __name__ == "__main__":
    ...
    br = BootRecord(b0)  
    print(br)
    print(hex(br.to_physical_offset(2))) # 102 -> 기대 : 500000, 결과 : 464000
